...
def inference(x, batch_size, n_classes, training=True, usBN=True):
    ...
    block2_5 = res_block_layers(block2_4, "block2_5", [128, 512], False, 1)
    block2_6 = res_block_layers(block2_5, "block2_6", [128, 512], False, 1)
    block2_7 = res_block_layers(block2_6, "block2_7", [128, 512], False, 1)
    block2_8 = res_block_layers(block2_7, "block2_8", [128, 512], False, 1)

    block3_1 = res_block_layers(block2_8, "block3_1", [256, 1024], True, 2)
    ...
    block3_7 = res_block_layers(block3_6, "block3_7", [256, 1024], False, 1)
    block3_8 = res_block_layers(block3_7, "block3_8", [256, 1024], False, 1)
    block3_9 = res_block_layers(block3_8, "block3_9", [256, 1024], False, 1)
    block3_10 = res_block_layers(block3_9, "block3_10", [256, 1024], False, 1)
    block3_11 = res_block_layers(block3_10, "block3_11", [256, 1024], False, 1)
    block3_12 = res_block_layers(block3_11, "block3_12", [256, 1024], False, 1)
    block3_13 = res_block_layers(block3_12, "block3_13", [256, 1024], False, 1)
    block3_14 = res_block_layers(block3_13, "block3_14", [256, 1024], False, 1)
    block3_15 = res_block_layers(block3_14, "block3_15", [256, 1024], False, 1)
    block3_16 = res_block_layers(block3_15, "block3_16", [256, 1024], False, 1)
    block3_17 = res_block_layers(block3_16, "block3_17", [256, 1024], False, 1)
    block3_18 = res_block_layers(block3_17, "block3_18", [256, 1024], False, 1)
    block3_19 = res_block_layers(block3_18, "block3_19", [256, 1024], False, 1)
    block3_20 = res_block_layers(block3_19, "block3_20", [256, 1024], False, 1)
    block3_21 = res_block_layers(block3_20, "block3_21", [256, 1024], False, 1)
    block3_22 = res_block_layers(block3_21, "block3_22", [256, 1024], False, 1)
    block3_23 = res_block_layers(block3_22, "block3_23", [256, 1024], False, 1)
    block3_24 = res_block_layers(block3_23, "block3_24", [256, 1024], False, 1)
    block3_25 = res_block_layers(block3_24, "block3_25", [256, 1024], False, 1)
    block3_26 = res_block_layers(block3_25, "block3_26", [256, 1024], False, 1)
    block3_27 = res_block_layers(block3_26, "block3_27", [256, 1024], False, 1)
    block3_28 = res_block_layers(block3_27, "block3_28", [256, 1024], False, 1)
    block3_29 = res_block_layers(block3_28, "block3_29", [256, 1024], False, 1)
    block3_30 = res_block_layers(block3_29, "block3_30", [256, 1024], False, 1)
    block3_31 = res_block_layers(block3_30, "block3_31", [256, 1024], False, 1)
    block3_32 = res_block_layers(block3_31, "block3_32", [256, 1024], False, 1)
    block3_33 = res_block_layers(block3_32, "block3_33", [256, 1024], False, 1)
    block3_34 = res_block_layers(block3_33, "block3_34", [256, 1024], False, 1)
    block3_35 = res_block_layers(block3_34, "block3_35", [256, 1024], False, 1)
    block3_36 = res_block_layers(block3_35, "block3_36", [256, 1024], False, 1)

    block4_1 = res_block_layers(block3_36, "block4_1", [512, 2048], True, 2)
