...
# 原始图片的存储位置
orig_picture = 'D:/tensorflow/practicePlus/cats_vs_dogs/train/'

# 生成图片的存储位置
gen_picture = 'D:/tesorflow/practicePlus/cats_vs_dogs/train_pre/'
...
def create_record():
    ...
    for index, name in enumerate(classes):
        ...
        class_path = orig_picture + "/"
        for img_name in os.listdir(class_path):
            img_path = class_path + img_name
            img = Image.open(img_path)
            img = img.resize((208, 208))  # 设置需要转换的图片大小
